...
export default function MovieCard({ movie }: MovieCardProps) {
  ...
  return (
    <>
      <div className='overflow-hidden rounded-lg bg-white shadow-md transition-all hover:shadow-lg cursor-pointer' onClick={() => setIsOpen(true)}>
      ...
      {isOpen && <MovieModal movie={movie} setIsOpen={setIsOpen} />}
    </>
  );
}
