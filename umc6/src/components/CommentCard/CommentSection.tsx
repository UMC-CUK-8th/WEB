...
import { useGetInfiniteCommentList } from "../../hooks/queries/useGetInfiniteCommentsList";
import CommentSkeletonList from "./CommentCardSkeletonList";
import { Comment } from "../../types/lp";
import CommentSkeleton from "./CommentCardSkeleton";
  ...
  return (
    <div className="mt-8">
      ...
      <div className="mb-4">
        ...
        />
        <button
          className="mt-2 bg-gray-400 text-white px-4 py-1 rounded"
          disabled
        >
          등록
        </button>
      ...
      {hasNextPage && (
        <button
          ...
          className="mt-4 bg-[#ac0576] text-white px-2 py-2 rounded"
        >
