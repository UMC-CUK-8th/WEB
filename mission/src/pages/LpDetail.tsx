...
const LpDetail = () => {
  ...
  return (
    <div className='bg-[#1e1e1c] w-2/3 h-screen overflow-y-auto rounded-xl m-4'>
      {!isPendingLpDetail && !isPendingLpComment && (
        <div className='text-white'>
          ...
          <div className='flex justify-center mt-10'>
            <div className='w-[70%] h-[70%] shadow-black shadow-md flex justify-center object-cover relative mb-5'>
          ...
          <span className='flex justify-center mt-10 items-center gap-4'><FaRegHeart size={20}/> {lpDetail.likes.length}</span>
