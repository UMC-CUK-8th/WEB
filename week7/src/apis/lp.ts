import { RequestLpDTO, RequestPostCommentDTO, RequestPostLpDTO, ResponseCommentListDTO, ResponseLikeLpDTO, ResponseLpDTO, ResponseLpListDTO, ResponsePostCommentDTO, ResponsePostLpDTO } from '../types/lp';
