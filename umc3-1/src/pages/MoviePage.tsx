...
export default function MoviePage() /*: Element*/ {
    ...
    useEffect((): void => {
        const fetchMovies = async () : Promise<void> => {
            ...
            try {
                const {data} = await axios.get<MovieResponse>( //axios 타입 중요함
    ...
    if(isError) {
        return (
            <div className='text-center'>
                ...
                <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3hjfmknhV8-AAbI6FPZEvhqPzBxKqAlL45w&s' alt="에러 이미지" className='w-50 h-50 mb-4 mx-auto'></img>
            </div>
        );
    }
